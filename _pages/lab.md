...
<details>
  ...
  <ul>
    ...
    <li>
      Lab 4
      <a href="/files/uwo/Quant1/2025/l4/quant1_Lab4.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
    ...
    <li>
      Lab 5
      <a href="/files/uwo/Quant1/2025/l5/quant1_Lab5.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
      <a href="/files/uwo/Quant1/2025/l5/Lab5.html" class="btn--faicon">
        <i class="fa fa-arrow-up-right-from-square"></i>
      </a>
    </li>
    <li>
      Lab 6
      <a href="/files/uwo/Quant1/2025/l6/quant1_Lab6.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
      <a href="/files/uwo/Quant1/2025/l6/Lab6.html" class="btn--faicon">
        <i class="fa fa-arrow-up-right-from-square"></i>
      </a>
    </li>
    <li>
      Lab 7
      <a href="/files/uwo/Quant1/2025/l7/quant1_Lab7.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
      <a href="/files/uwo/Quant1/2025/l7/Lab7.html" class="btn--faicon">
        <i class="fa fa-arrow-up-right-from-square"></i>
      </a>
    </li>
    <li>
      Lab 8
      <a href="/files/uwo/Quant1/2025/l8/quant1_Lab8.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
      <a href="/files/uwo/Quant1/2025/l8/Lab8.html" class="btn--faicon">
        <i class="fa fa-arrow-up-right-from-square"></i>
      </a>
    </li>
    <li>
      Lab 9
      <a href="/files/uwo/Quant1/2025/l9/quant1_Lab9.zip" download class="btn--faicon">
        <i class="fa fa-cloud-arrow-down"></i>
      </a>
      <a href="/files/uwo/Quant1/2025/l9/Lab9.html" class="btn--faicon">
        <i class="fa fa-arrow-up-right-from-square"></i>
      </a>
    </li>
    <li>
